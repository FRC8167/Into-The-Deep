...
//                                wristRotate.rotateTrig(0),
                        ...
                        new SleepAction(2),
                        armPivot.armTrig(18,-3.5),
                        slide.slideTrig(18,-3.5),
                        wristPivot.wristTrigFlat(18,-3.5, true),
                        goGrab,
                        new SleepAction(1.5),
                        gripper.toggle(),
                        new SleepAction(1.5),
                        armPivot.armTrig(18,13),
                        slide.slideTrig(18,13),
                        wristPivot.wristTrig(18,13, true),
                        goAdjust,
                        new SequentialAction(
