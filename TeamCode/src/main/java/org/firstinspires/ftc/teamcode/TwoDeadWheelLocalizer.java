...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -56.1449000973613 ;// y position of the parallel encoder (in tick units)
        public double perpXTicks = 693.3129500700688; // x position of the perpendicular encoder (in tick units)
    }
